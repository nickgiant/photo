...
public class Tag extends Span {
    ...
    public Tag(Icon symbol, String text, Color.Text color) {
        this(createIcon(symbol), text, color);
    }

    public Tag(Icon symbol, String text) {
    ...
    private static Component createIcon(Icon symbol)
    {
        symbol.addClassName(IconSize.SMALL);
        return symbol;
    }
