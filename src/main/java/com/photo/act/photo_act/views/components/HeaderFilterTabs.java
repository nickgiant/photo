...
public class HeaderFilterTabs extends Div {

    private static final Logger logger = LoggerFactory.getLogger(GalleryImageViewCard.class);
    private RecordService recordService;
    private boolean isMobile;

    public HeaderFilterTabs(RecordService recordService, boolean isMobile) {
...
//        VerticalLayout layoutHolder = new VerticalLayout();
//        layoutHolder.addClassNames(
...
//                LumoUtility.Width.FULL, LumoUtility.AlignItems.CENTER, LumoUtility.JustifyContent.CENTER,
//                LumoUtility.Padding.NONE, LumoUtility.Margin.NONE,
//                LumoUtility.TextColor.TERTIARY, LumoUtility.TextAlignment.CENTER, LumoUtility.FontSize.SMALL
//        );
//        Div divSection = new Div("Click one to filter.");
//        section.add(divSection, layoutFilters);
//
////        layoutHolder.add(section);
//
//        String strHtmlTabs = "" +
//                "<div class=\"tabs\">" +
////                "<div>" +
...
//                "  <ul>\n" +
//                "    <li title=\"Filters\"><label for=\"tab1\" role=\"button\"><svg viewBox=\"0 0 24 24\">\n" +
//                "          <path d=\"M14,2A8,8 0 0,0 6,10A8,8 0 0,0 14,18A8,8 0 0,0 22,10H20C20,13.32 17.32,16 14,16A6,6 0 0,1 8,10A6,6 0 0,1 14,4C14.43,4 14.86,4.05 15.27,4.14L16.88,2.54C15.96,2.18 15,2 14,2M20.59,3.58L14,10.17L11.62,7.79L10.21,9.21L14,13L22,5M4.93,5.82C3.08,7.34 2,9.61 2,12A8,8 0 0,0 10,20C10.64,20 11.27,19.92 11.88,19.77C10.12,19.38 8.5,18.5 7.17,17.29C5.22,16.25 4,14.21 4,12C4,11.7 4.03,11.41 4.07,11.11C4.03,10.74 4,10.37 4,10C4,8.56 4.32,7.13 4.93,5.82Z\" />\n" +
//                "        </svg><br><span>Filters</span></label></li>\n" +
...
//                "    <li title=\"Order\"><label for=\"tab4\" role=\"button\"><svg viewBox=\"0 0 24 24\">\n" +
//                "          <path d=\"M11,9H13V7H11M12,20C7.59,20 4,16.41 4,12C4,7.59 7.59,4 12,4C16.41,4 20,7.59 20,12C20,16.41 16.41,20 12,20M12,2A10,10 0 0,0 2,12A10,10 0 0,0 12,22A10,10 0 0,0 22,12A10,10 0 0,0 12,2M11,17H13V11H11V17Z\" />\n" +
//                "        </svg><br><span>Order</span></label></li>\n" +
//                "  </ul>\n" +
//                "\n" +
//                "  <div class=\"slider\">\n" +
...
//                "</div>";
//
//        Html html = new Html(strHtmlTabs);
//
//        tabHeader.add(html);
...
//                    LumoUtility.Background.CONTRAST_5,
        ...
        String strThirdTab = "Tutor or Author";
        ...
        String strHtmlTabs2 = "" +
                ...
                "  <div class=\"tabs\">\n" +
                "  <label class=\"tab\" id=\"one-tab\" for=\"one\">" + strFirstTab + "</label>\n" +
                "  <label class=\"tab\" id=\"two-tab\" for=\"two\">" + strSecondTab + "</label>\n" +
                "  <label class=\"tab\" id=\"three-tab\" for=\"three\">" + strThirdTab + "</label>\n" +
                "    </div>\n" +
                "  <div class=\"panels\">\n" +
