...
/**
 * Builds OgMetaDto for photo stories from the photo_stories table.
 * Used as a fallback when the story is not yet in the content table.
 */
@Service
...
public class StoryOgService {
    ...
    @Cacheable(value = "og-meta", key = "'photo_story::' + #slug", unless = "#result == null")
