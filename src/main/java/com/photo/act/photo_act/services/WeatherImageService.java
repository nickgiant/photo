...
public class WeatherImageService {
    ...
    public String getImageApiWeather(Weather weather) {
        String weatherType = weather.getWeatherState().getWeatherConditionEnum().getName();
        Integer comparedTime = Integer.valueOf(weather.getCalculationTime().getHour());
        Integer sunrise = Integer.valueOf(6);
        Integer sunset = Integer.valueOf(18);
        ;
        return imageReturn(comparedTime, sunrise, sunset, weatherType);
    }

    public String getImageApiForecast(WeatherForecast weather) {
        String weatherType = weather.getWeatherState().getWeatherConditionEnum().getName();
        Integer comparedTime = Integer.valueOf(weather.getForecastTime().getHour());
        Integer sunrise = Integer.valueOf(6);
        Integer sunset = Integer.valueOf(18);
        ;
        return imageReturn(comparedTime, sunrise, sunset, weatherType);
