...
@Table(name = "news_views",
    indexes = {
        @Index(name = "idx_news_views_news_id", columnList = "news_id"),
        @Index(name = "idx_news_views_ip",      columnList = "ip_address")
    })
public class NewsViewEntity {
    ...
    protected NewsViewEntity() {}

    public NewsViewEntity(Long newsId, Integer userId, String ipAddress,
